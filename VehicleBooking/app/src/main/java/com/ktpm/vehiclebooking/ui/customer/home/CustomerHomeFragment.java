    ...
    private void setBikeBtnActionHandler(){
        bikeBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                customerBookingViewModel.setTransportationType(Constants.Transportation.Type.bikeType);
    ...
    private void setCarBtnActionHandler(){
        carBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                CustomerBookingViewModel customerBookingViewModel = ViewModelProviders.of(requireActivity()).get(CustomerBookingViewModel.class);
                customerBookingViewModel.setTransportationType(Constants.Transportation.Type.carType);
